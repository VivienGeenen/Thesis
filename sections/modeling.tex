...
\label{thermalmodel}
   ...
   % \vspace{0.3cm}
    ...
    \end{align}
    Now, the greyest- command executes the parameter identification (see in Appendix the initial values and the identified values) and we obtain the ready model.
