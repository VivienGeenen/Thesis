...
Die Vorgehensweise im MPC script ist durch die Verwendung des Tools CasAdi bestimmt. Casadi ist open-source tool for nonlinear optimization and algorithmic differentiation und zeichnet sich durch die symbolische Rechnungen aus. Wir können CasAdi durch einen einfachen import mit matlab kombinieren Quelle CasAdi.\newline
